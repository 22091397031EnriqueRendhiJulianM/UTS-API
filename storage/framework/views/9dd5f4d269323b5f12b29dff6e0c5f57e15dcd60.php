...
<?php $__env->startSection('body'); ?>
    <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="<?php echo e(route('product.create')); ?>" class="btn btn-primary">Add Address</a>
    </div>
    <hr />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 4\Pengujian Perangkat Lunak\tugas-ppl\resources\views/address/index.blade.php ENDPATH**/ ?>