...
<?php $__env->startSection('body'); ?>
    ...
    <div class="input-group mb-3 mt-3">
        ...
        <!-- <button type="search" class="btn btn-primary" href="<?php echo e(route('Contact.create')); ?>" >Search</button> -->
    </div>
    <hr />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SEMESTER 4\Pengujian Perangkat Lunak\tugas-ppl\resources\views/Contact/index.blade.php ENDPATH**/ ?>